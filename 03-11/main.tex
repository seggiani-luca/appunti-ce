...
Abbiamo visto finora le \textbf{interruzioni esterne mascherabili}.
Vediamo in verità che esistono altri tipi di interruzione, da cui la lista completa:
\begin{itemize}
	\item \textbf{Interruzioni esterne:} il tipo che abbiamo visto finora, di cui notiamo le:
		\begin{itemize}
	...
	\item \textbf{Interruzioni interne} (\textit{Eccezioni}): eventi che non arrivano dall'esterno, ma si generano all'interno del processore stesso.
		Questi sono particolari errori logici che potrebbe incontrare il processore, come ad esempio la divisione per 0, il tentativo di eseguire un istruzione non riconosciuta, ecc...
	...
	\item \textbf{Interruzioni software:} interruzioni che vengono lanciate direttamente dal programma attraverso l'istruzione \lstinline|INT|, la cui utilità verrà vista studiando il meccanismo della \textit{protezione}.
\end{itemize}
