...
\subsection{Altri tipi di interruzioni}
Abbiamo visto finora le \textbf{interruzioni esterne mascherabili}.
Vediamo in verità che esistono altri tipi di interruzione, fra cui:
\begin{itemize}
	...
	\item \textbf{Eccezioni:} eventi che non arrivano dall'esterno, ma si generano all'interno del processore stesso.
