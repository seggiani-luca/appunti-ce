...
Abbiamo quindi che i make code e i break code dei diversi tasti in una classica tastiera layout US sono i seguenti, nel cosiddetto \textit{set 0} (man mano che le tastiere si sono evolute, sono stati introdotti nuovi set con codifiche diverse):

\begin{center}
	\includegraphics{../figures/keyb.png}
\end{center}
